(function () {
    ...
    $c_Ltutorial_webapp_TutorialApp$.prototype.setupUI__V = (function () {
        ...
        this.appendPar__Lorg_scalajs_dom_raw_Node__T__Lorg_scalajs_dom_raw_Node__V($m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().body, "Hello World", this.appendPar$default$3__Lorg_scalajs_dom_raw_Node());
        this.appendPar__Lorg_scalajs_dom_raw_Node__T__Lorg_scalajs_dom_raw_Node__V($m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().body, "Super Cool Page", $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().createElement("h1"))
    });
    $c_Ltutorial_webapp_TutorialApp$.prototype.appendPar__Lorg_scalajs_dom_raw_Node__T__Lorg_scalajs_dom_raw_Node__V = (function (targetNode, text, el) {
        el.textContent = text;
        targetNode.appendChild(el)
    });
    $c_Ltutorial_webapp_TutorialApp$.prototype.appendPar$default$3__Lorg_scalajs_dom_raw_Node = (function () {
        return $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().createElement("p")
    });
    $c_Ltutorial_webapp_TutorialApp$.prototype.addClickedMessage__V = (function () {
        this.appendPar__Lorg_scalajs_dom_raw_Node__T__Lorg_scalajs_dom_raw_Node__V($m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().body, "You clicked the button!", this.appendPar$default$3__Lorg_scalajs_dom_raw_Node())
    });
