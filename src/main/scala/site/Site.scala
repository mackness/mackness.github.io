    ...
    <div id="site-container">
      ...
      <div id="social-container">
        <a href="https://www.linkedin.com/in/macksolomon" class="social-link">
          <img src={Badge.linkedin} />
        </a>
        <a href="mailto:macksol@gmail.com" class="social-link">
          <img src={Badge.gmail} />
        </a>
        <a href="https://mackness.github.io/resume.pdf" class="social-link">
      ...
      <p><code>Made with ❤️ using <a href="https://www.scala-js.org/">Scala.js</a></code></p>
    </div>
  }
}
